...
class GUI(Tk):
    ...
    def main (self):
        ...
        self.darsad = PhotoImage(file = 'img/percent.png')
        self.si = PhotoImage(file = 'img/C.png')
        self.sie = PhotoImage(file = 'img/CE.png')
        self.taqsim = PhotoImage(file = 'img/Division.png')
        ...
        self.haft = PhotoImage(file = 'img/7.png')
        self.hasht = PhotoImage(file = 'img/8.png')
        self.noh = PhotoImage(file = 'img/9.png')
        self.zarb = PhotoImage(file = 'img/multiplication.png')
        ...
        self.chahar = PhotoImage(file = 'img/4.png')
        self.panj = PhotoImage(file = 'img/5.png')
        self.shish = PhotoImage(file = 'img/6.png')
        self.menha = PhotoImage(file = 'img/minus.png')
        ...
        self.yek = PhotoImage(file = 'img/1.png')
        self.do = PhotoImage(file = 'img/2.png')
        self.se = PhotoImage(file = 'img/3.png')
        self.jam = PhotoImage(file = 'img/plus.png')
        ...
        self.manfi = PhotoImage(file = 'img/negative.png')
        self.sefr = PhotoImage(file = 'img/0.png')
        self.noghte = PhotoImage(file = 'img/dot.png')
        self.mosavi = PhotoImage(file = 'img/equal.png')
        ...
        self.baz = PhotoImage(file = 'img/Oparenthesis.png')
        self.baste = PhotoImage(file = 'img/Cparenthesis.png')
        self.pp = PhotoImage(file = 'img/p.png')
        ...
        self.sin2 = PhotoImage(file = 'img/sin.png')
        self.cos2 = PhotoImage(file = 'img/cos.png')
        self.tan2 = PhotoImage(file = 'img/tan.png')
        ...
        self.tavan = PhotoImage(file = 'img/exponent.png')
        self.radi = PhotoImage(file = 'img/radical.png')
        self.fac = PhotoImage(file = 'img/factorial.png')
        ...
        self.xdo = PhotoImage(file = 'img/exponent2.png')
        self.radi3 = PhotoImage(file = 'img/radical3.png')
        self.log = PhotoImage(file = 'img/log.png')
        ...
        self.ghadr = PhotoImage(file = 'img/absolute.png')
        self.besad = PhotoImage(file = 'img/100.png')
        self.eee = PhotoImage(file = 'img/e.png')
